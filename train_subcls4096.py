...
if __name__ == '__main__':
    ...
    parser.add_argument("--network", default="network.resnet38_subcls", type=str)
    parser.add_argument("--lr", default=0.01, type=float)
    parser.add_argument("--num_workers", default=8, type=int)
    parser.add_argument("--wt_dec", default=5e-4, type=float)
    parser.add_argument("--weights", default='res38_cls.pth', type=str)#download weight which is 47.2 on val
    parser.add_argument("--train_list", default="voc12/train_aug.txt", type=str)
    parser.add_argument("--val_list", default="voc12/val.txt", type=str)
    parser.add_argument("--session_name", default="res38k", type=str)
