...
if __name__ == '__main__':
    ...
    parser.add_argument("--network", default="network.resnet38_cls1", type=str)
    parser.add_argument("--lr", default=0.01, type=float)
    parser.add_argument("--num_workers", default=8, type=int)
    parser.add_argument("--wt_dec", default=5e-4, type=float)
    parser.add_argument("--weights", required='ilsvrc-cls_rna-a1_cls1000_ep-0001.params', type=str)
    parser.add_argument("--train_list", default="voc12/train_aug.txt", type=str)
    parser.add_argument("--val_list", default="voc12/val.txt", type=str)
    parser.add_argument("--session_name", default="resnet38_cls1", type=str)
    ...
    if args.weights[-7:] == '.params':
        ...
        torch.save(weights_dict, 'resnet38_clsimgnet.pth')
    ...
    for ep in range(args.max_epoches):
        ...
        for iter, pack in enumerate(train_data_loader):
            ...
            timer.reset_stage()
        torch.save(model.module.state_dict(), args.session_name + str(ep)+'.pth')
