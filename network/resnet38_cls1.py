...
class Net(network.resnet38d.Net):
    def __init__(self):
        ...
        # torch.nn.init.xavier_uniform_(self.fc8.weight,gain=0.1)
        # torch.nn.init.xavier_uniform_(self.conv8.weight,gain=0.1)
        self.not_training = [self.conv1a, self.b2, self.b2_1, self.b2_2]
        self.from_scratch_layers = [self.fc8,self.conv8]
